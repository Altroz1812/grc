...
SELECT id, get_next_sequential_id('departments')::TEXT, 'departments'
FROM departments
ORDER BY created_at;

-- 2. Update user_roles table  
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('user_roles')::TEXT, 'user_roles'
FROM user_roles
ORDER BY created_at;

-- 3. Update employees table
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('employees')::TEXT, 'employees'
FROM employees
ORDER BY created_at;

-- 4. Update profiles table
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('profiles')::TEXT, 'profiles'
FROM profiles
ORDER BY created_at;

-- 5. Update compliances table
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('compliances')::TEXT, 'compliances'
FROM compliances
ORDER BY created_at;

-- 6. Update compliance_assignments table
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('compliance_assignments')::TEXT, 'compliance_assignments'
FROM compliance_assignments
ORDER BY created_at;

-- 7. Update other tables
INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('compliance_user_assignments')::TEXT, 'compliance_user_assignments'
FROM compliance_user_assignments
ORDER BY created_at;

INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('compliance_metrics')::TEXT, 'compliance_metrics'
FROM compliance_metrics
ORDER BY created_at;

INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('compliance_bulk_uploads')::TEXT, 'compliance_bulk_uploads'
FROM compliance_bulk_uploads
ORDER BY created_at;

INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('escalation_items')::TEXT, 'escalation_items'
FROM escalation_items
ORDER BY created_at;

INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('user_audit_logs')::TEXT, 'user_audit_logs'
FROM user_audit_logs
ORDER BY created_at;

INSERT INTO id_mappings (old_uuid, new_id, table_name)
SELECT id, get_next_sequential_id('user_sessions')::TEXT, 'user_sessions'
FROM user_sessions
ORDER BY created_at;
...
-- Update user_roles  
ALTER TABLE user_roles ALTER COLUMN id TYPE TEXT;
...
-- Update employees and their foreign key references
...
-- Update compliances
ALTER TABLE compliances ALTER COLUMN id TYPE TEXT;
...
ALTER TABLE compliance_assignments ALTER COLUMN id TYPE TEXT;
ALTER TABLE compliance_assignments ALTER COLUMN compliance_id TYPE TEXT;
ALTER TABLE compliance_assignments ALTER COLUMN assigned_to TYPE TEXT;
ALTER TABLE compliance_assignments ALTER COLUMN checker_id TYPE TEXT;
...
ALTER TABLE compliance_user_assignments ALTER COLUMN id TYPE TEXT;
ALTER TABLE compliance_user_assignments ALTER COLUMN compliance_id TYPE TEXT;
ALTER TABLE compliance_user_assignments ALTER COLUMN user_id TYPE TEXT;
ALTER TABLE compliance_user_assignments ALTER COLUMN assigned_by TYPE TEXT;
...
ALTER TABLE compliance_metrics ALTER COLUMN id TYPE TEXT;
...
ALTER TABLE compliance_bulk_uploads ALTER COLUMN id TYPE TEXT;
ALTER TABLE compliance_bulk_uploads ALTER COLUMN uploaded_by TYPE TEXT;
...
ALTER TABLE escalation_items ALTER COLUMN id TYPE TEXT;
ALTER TABLE escalation_items ALTER COLUMN compliance_assignment_id TYPE TEXT;
ALTER TABLE escalation_items ALTER COLUMN escalated_to TYPE TEXT;
...
ALTER TABLE user_audit_logs ALTER COLUMN id TYPE TEXT;
ALTER TABLE user_audit_logs ALTER COLUMN user_id TYPE TEXT;
ALTER TABLE user_audit_logs ALTER COLUMN performed_by TYPE TEXT;
...
ALTER TABLE user_sessions ALTER COLUMN id TYPE TEXT;
